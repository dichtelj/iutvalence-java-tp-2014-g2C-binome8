...
/** Deplacement de bille(s)*/
	...
	{
		if(mouvement.getType() == Type.Decaler)
		{
			if(mouvement.getDirection()==Direction.HAUT)
			{
		...
		else if(mouvement.getType() == Type.PousserDiag)
		{
			if(mouvement.getDirection() == Direction.BASDROITE)
			{
				
			}
			else if (mouvement.getDirection()==Direction.BASGAUCHE)
			{
				
			}
			else if (mouvement.getDirection()==Direction.HAUTGAUCHE)
			{
